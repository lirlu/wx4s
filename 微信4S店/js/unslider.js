...
(function($, f) {
	var Unslider = function() {
		...
		_.init = function(el, o) {
			...
			ul.css({'margin': 0, 'padding': 0, position: 'relative', left: 0, width: _.max[0] * len});
			li.find('img').css({'width': _.max[0]});
			li.css({'float': 'left', width: _.max[0], height: li.find('img').outerHeight()});
